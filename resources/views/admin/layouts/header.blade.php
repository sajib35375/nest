<header class="main-header navbar">
    ...
    <div class="col-nav">
        ...
        <ul class="nav">
            @php
                $unseenContactCount = \App\Models\ContactForm::where('status', false)->count();
            @endphp
            <li class="nav-item">
                <a class="nav-link btn-icon" href="{{ route('contact-message') }}">
                    <i class="material-icons md-notifications animation-shake"></i>
                    <span class="badge rounded-pill">{{ $unseenContactCount }}</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            @endphp
            <li class="dropdown nav-item">
                <a class="dropdown-toggle" data-bs-toggle="dropdown" href="#" id="dropdownAccount" aria-expanded="false"> <img class="img-xs rounded-circle" src="{{ (!empty($admin->profile_photo_path))? URL::to('upload/admin_images/'.$admin->profile_photo_path) : URL::to('upload/no_image.jpg') }}" alt="User" /></a>
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownAccount">
                    <a class="dropdown-item" href="{{ route('admin.profile') }}"><i class="material-icons md-perm_identity"></i>Edit Profile</a>
                    <a class="dropdown-item" href="{{ route('admin.change.password') }}"><i class="material-icons md-settings"></i>Change Password</a>
